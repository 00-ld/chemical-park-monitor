...
('CO', '一氧化碳', '0-1000 ppm', 1.5, 30, '高毒气体，需重点监测', 1, 0.90),
('H2S', '硫化氢', '0-100 ppm', 0.5, 25, '剧毒气体，优先低位安装', 1, 0.95),
('CH4', '甲烷', '0-100% LEL', 2.0, 35, '可燃气体，高位安装', 2, 0.80),
('O2', '氧气', '0-30% VOL', 1.5, 30, '缺氧/富氧监测', 2, 0.30);
